  ...
  return (
    <footer className="h-[44px] border-t border-border bg-background flex items-center justify-between px-4 md:px-6">
      ...
      <div className="flex items-center gap-2 md:gap-3 text-[11px] ml-auto">
        <span className="hidden sm:inline text-muted-foreground">{currentPreset}</span>
        <span className="hidden sm:inline text-muted-foreground">v1.2.3</span>
        ...
        <div className="flex items-center gap-1.5">
          {!dirty && (
            <>
              ...
              <span className="hidden sm:inline text-green-600 font-medium">Saved</span>
            </>
          )}
          {dirty && (
            <>
        ...
        <div className="flex items-center gap-1.5 md:gap-2">
          <Button
            ...
            size="sm"
            onClick={handleSave}
            className="h-7 text-[10px] md:text-[11px] px-2 md:px-3"
          >
            Save
          </Button>
          <Button
